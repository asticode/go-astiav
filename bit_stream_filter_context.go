...
// https://ffmpeg.org/doxygen/7.1/structAVBSFContext.html
...
// https://ffmpeg.org/doxygen/7.1/group__lavc__bsf.html#ga7da65af303e20c9546e15ec266b182c1
...
// https://ffmpeg.org/doxygen/7.1/structAVBSFContext.html#aa5d5018816daac804414c459ec8a1c5c
...
// https://ffmpeg.org/doxygen/7.1/group__lavc__bsf.html#ga242529d54013acf87e94273d298a5ff2
func (bsfc *BitStreamFilterContext) Initialize() error {
	return newError(C.av_bsf_init(bsfc.c))
}

// https://ffmpeg.org/doxygen/7.1/structAVBSFContext.html#a5c799e50f572340b69d4c79cda8f2de9
func (bsfc *BitStreamFilterContext) PrivateData() *PrivateData {
	return newPrivateDataFromC(bsfc.c.priv_data)
}

// https://ffmpeg.org/doxygen/7.1/group__lavc__bsf.html#gaada9ea8f08d3dcf23c14564dbc88992c
...
// https://ffmpeg.org/doxygen/7.1/group__lavc__bsf.html#ga7fffb6c87b91250956e7a2367af56b38
...
// https://ffmpeg.org/doxygen/7.1/group__lavc__bsf.html#ga08d53431e76355f88e27763b1940df4f
...
// https://ffmpeg.org/doxygen/7.1/structAVBSFContext.html#ad75adf988c00f89202099c87ea39f0db
...
// https://ffmpeg.org/doxygen/7.1/structAVBSFContext.html#a702ace639b8193475cf0a12ebdebd738
func (bsfc *BitStreamFilterContext) InputCodecParameters() *CodecParameters {
	return newCodecParametersFromC(bsfc.c.par_in)
}

// https://ffmpeg.org/doxygen/7.1/structAVBSFContext.html#ab58f8c37eec197e0f30d17d60959a60d
