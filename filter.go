...
// https://ffmpeg.org/doxygen/7.1/structAVFilter.html#a04e408702054370fbe35c8d5b49f68cb
func (f *Filter) NbInputs() int {
	return int(f.c.nb_inputs)
}

// https://ffmpeg.org/doxygen/7.1/structAVFilter.html#abb166cb2c9349de54d24aefb879608f4
func (f *Filter) NbOutputs() int {
	return int(f.c.nb_outputs)
}

// https://ffmpeg.org/doxygen/7.1/structAVFilter.html#ad311151fe6e8c87a89f895bef7c8b98b
...
// https://ffmpeg.org/doxygen/7.1/structAVFilter.html#ad0608786fa3e1ca6e4cc4b67039f77d7
