...
func TestFormatContext(t *testing.T) {
	fc1, err := globalHelper.inputFormatContext("video_with_chapters.mp4", nil)
	require.NoError(t, err)
	ss := fc1.Streams()
	require.Len(t, ss, 3)
	s1 := ss[0]

	require.Equal(t, int64(608682), fc1.BitRate())
	...
	require.Equal(t, 2, fc1.NbChapters())
	require.Len(t, fc1.Chapters(), 2)
	require.Equal(t, 3, fc1.NbStreams())
	require.Len(t, fc1.Streams(), 3)
	cl := fc1.Class()
	require.NotNil(t, cl)
	...
	defer fc5.Free()
	ch, err := fc5.NewChapter()
	require.NoError(t, err)
	require.NotNil(t, ch)
	require.Equal(t, 1, fc5.NbChapters())
