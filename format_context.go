...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__core.html#gac7a91abf2f59648d995894711f070f62
func AllocFormatContext() *FormatContext {
	return newFormatContextFromC(C.avformat_alloc_context())
}

// https://ffmpeg.org/doxygen/8.1/avformat_8h.html#af5930942120e38a4766dc0bb9e4cae74
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__core.html#gac2990b13b68e831a408fce8e1d0d6445
...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a972a02b9e3b542a426e323a8f8e3ea41
func (fc *FormatContext) BitRate() int64 {
	return int64(fc.c.bit_rate)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a0c396740b9a2487aa57d4352d2dc1687
...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a4e6076343df1ffc2e16cedbba3f3f397
func (fc *FormatContext) CtxFlags() FormatContextCtxFlags {
	return FormatContextCtxFlags(fc.c.ctx_flags)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#ad0ea78ac48f5bb0a15a15c1c472744d9
func (fc *FormatContext) Duration() int64 {
	return int64(fc.c.duration)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a0302506d4b3434da77b8b3db43821aa0
func (fc *FormatContext) EventFlags() FormatEventFlags {
	return FormatEventFlags(fc.c.event_flags)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a32379cc371463b235d54235d4af06a15
...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a5b37acfe4024d92ee510064e80920b40
...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a6c01f25ef062e0398b0b55dd337246ed
func (fc *FormatContext) InputFormat() *InputFormat {
	return newInputFormatFromC(fc.c.iformat)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a5e6814c9de3c272396f07e2ff18c7b27
func (fc *FormatContext) IOFlags() IOContextFlags {
	return IOContextFlags(fc.c.avio_flags)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a4d860662c014f88277c8f20e238fa694
func (fc *FormatContext) MaxAnalyzeDuration() int64 {
	return int64(fc.c.max_analyze_duration)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a3019a56080ed2e3297ff25bc2ff88adf
...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a58c8c4d0ea974e0fcb0ce06fb1174f9f
func (fc *FormatContext) NbPrograms() int {
	return int(fc.c.nb_programs)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a4c2c5a4c758966349ff513e95154d062
...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a0b748d924898b08b89ff4974afd17285
...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a37ba86cd5630097cdae01afbc2b40743
func (fc *FormatContext) OutputFormat() *OutputFormat {
	return newOutputFormatFromC(fc.c.oformat)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a1e7324262b6b78522e52064daaa7bc87
...
// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#ac4c0777e54085af2f3f1b27130e2b21b
func (fc *FormatContext) PrivateData() *PrivateData {
	return newPrivateDataFromC(fc.c.priv_data)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a2590129e00adfa726ab2033a10e905e9
func (fc *FormatContext) StartTime() int64 {
	return int64(fc.c.start_time)
}

// https://ffmpeg.org/doxygen/8.1/structAVFormatContext.html#a5017684cf0a84c990f60c8d50adec144
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__decoding.html#gac05d61a2b492ae3985c658f34622c19d
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__decoding.html#gae804b99aec044690162b8b9b110236a4
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__core.html#gab31f7c7c99dcadead38e8e83e0fdb828
func (fc *FormatContext) NewProgram(id int) *Program {
	return newProgramFromC(C.av_new_program(fc.c, C.int(id)), fc)
}

// https://ffmpeg.org/doxygen/8.1/group__lavf__core.html#gaf2c94216a6a19144e86cac843a0a4409
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__decoding.html#gad42172e27cddafb81096939783b157bb
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__decoding.html#ga4fdb3084415a82e3810de6ee60e46a61
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__decoding.html#gaa23f7619d8d4ea0857065d9979c75ac8
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__decoding.html#gaa03a82c5fd4fe3af312d229ca94cd6f3
func (fc *FormatContext) Flush() error {
	return newError(C.avformat_flush(fc.c))
}

// https://ffmpeg.org/doxygen/8.1/group__lavf__encoding.html#ga18b7b10bb5b94c4842de18166bc677cb
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__encoding.html#gaa85cc1774f18f306cd20a40fc50d0b36
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__encoding.html#ga37352ed2c63493c38219d935e71db6c1
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__encoding.html#ga7f14007e7dc8f481f054b21614dfec13
func (fc *FormatContext) WriteTrailer() error {
	return newError(C.av_write_trailer(fc.c))
}

// https://ffmpeg.org/doxygen/8.1/group__lavf__misc.html#gafa6fbfe5c1bf6792fd6e33475b6056bd
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__misc.html#ga698e6aa73caa9616851092e2be15875d
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__misc.html#gaa2a7353a6bb0c8726797abd56b176af0
...
// https://ffmpeg.org/doxygen/8.1/avformat_8c.html#a8d4609a8f685ad894c1503ffd1b610b4
...
// https://ffmpeg.org/doxygen/8.1/group__lavf__misc.html#gae2645941f2dc779c307eb6314fd39f10
