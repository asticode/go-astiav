...
// https://ffmpeg.org/doxygen/8.1/structAVFilterGraph.html
...
// https://ffmpeg.org/doxygen/8.1/group__lavfi.html#ga6c778454b86f845805ffd814b4ce51d4
func AllocFilterGraph() *FilterGraph {
	return newFilterGraphFromC(C.avfilter_graph_alloc())
}

// https://ffmpeg.org/doxygen/8.1/group__lavfi.html#ga871684449dac05050df238a18d0d493b
...
// https://ffmpeg.org/doxygen/8.1/group__lavfi.html#gadb442aca4e5a8c3ba740f6049f0a288b
func (g *FilterGraph) String() string {
	return C.GoString(C.avfilter_graph_dump(g.c, nil))
}

// https://ffmpeg.org/doxygen/8.1/structAVFilterGraph.html#af00925dd69b474fac48887efc0e1ac94
...
// https://ffmpeg.org/doxygen/8.1/structAVFilterGraph.html#ac28dcbf76e6fdd800295a2738d41660e
...
// https://ffmpeg.org/doxygen/8.1/structAVFilterGraph.html#a7fd96bbd6d1a3b730681dc0bf5107a5e
...
func (g *FilterGraph) NewBuffersinkFilterContext(f *Filter, name string) (*BuffersinkFilterContext, error) {
	...
	// Don't initialize here - let caller set parameters first
	fc := newFilterContext(c)
	g.fcs = append(g.fcs, fc)
	return newBuffersinkFilterContext(fc), nil
}

// https://ffmpeg.org/doxygen/8.1/group__lavfi.html#gaa9af17ecf4c5c87307b57cf08411088b
...
// https://ffmpeg.org/doxygen/8.1/group__lavfi.html#ga34f4ff420bd58da6747a3ff1fbedd001
...
// https://ffmpeg.org/doxygen/8.1/group__lavfi.html#ga2ecfd3667219b6cd1e37b7047cc0ef2b
...
// https://ffmpeg.org/doxygen/8.1/group__lavfi.html#ga1896c46b7bc6ff1bdb1a4815faa9ad07
func (g *FilterGraph) Configure() error {
	return newError(C.avfilter_graph_config(g.c, nil))
}

// https://ffmpeg.org/doxygen/8.1/group__lavfi.html#gaaad7850fb5fe26d35e5d371ca75b79e1
...
// https://ffmpeg.org/doxygen/8.1/structAVFilterGraph.html#a0ba5c820c760788ea5f8e40c476f9704
func (g *FilterGraph) NbFilters() int {
	return int(g.c.nb_filters)
}

// https://ffmpeg.org/doxygen/8.1/structAVFilterGraph.html#a1dafd3d239f7c2f5e3ac109578ef926d
