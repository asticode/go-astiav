...
// https://ffmpeg.org/doxygen/7.1/structAVPixFmtDescriptor.html
...
// https://ffmpeg.org/doxygen/7.1/structAVPixFmtDescriptor.html#a10736c3f1288eb87b23ede3ffdefb435
func (pfd *PixelFormatDescriptor) Name() string {
	return C.GoString(pfd.c.name)
}

// https://ffmpeg.org/doxygen/7.1/structAVPixFmtDescriptor.html#a5047d1e6b045f637345dbc305bf4357d
