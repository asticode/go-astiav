...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html
type CodecParameters struct {
	c *C.AVCodecParameters
}

// https://ffmpeg.org/doxygen/7.1/group__lavc__core.html#ga647755ab2252e93221bb345f3d5e414f
...
// https://ffmpeg.org/doxygen/7.1/group__lavc__core.html#ga950c8da55b8112077e640b6a0cb8cf36
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a5268fcf4ae8ed27edef54f836b926d93
func (cp *CodecParameters) BitRate() int64 {
	return int64(cp.c.bit_rate)
}

// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a4d581c205b18108a4f00e8fb3a2b26f9
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a9f76f2475ef24ff4c9771dd53072d040
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a9b6f7d220d100ba73defab295623356b
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#ae4c7ac718a75adb31b5f2076a02fdedf
func (cp *CodecParameters) ChromaLocation() ChromaLocation {
	return ChromaLocation(cp.c.chroma_location)
}

// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#aa884cae3fd16b30c61201a686664f96b
func (cp *CodecParameters) ColorPrimaries() ColorPrimaries {
	return ColorPrimaries(cp.c.color_primaries)
}

// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#afa6744d9b8766db47a5ff7bddf0f2404
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a020398a4963e932853cefc169d90456d
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#ac25ed8394e1efdbbcf28932ff0020893
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a9befe0b86412646017afb0051d144d13
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a0ce9631123719789e4c7b0c23c66d534
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a1ec57ee84f19cf65d00eaa4d2a2253ce
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a26ae48eeaf8b315eca03b207e11edc7c
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a58369c3a8a986935b572df5aa6361ce2
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#abee943e65d98f9763fa6602a356e774f
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a6b13b8a226ed923085718cd1323bfcb5
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a7d6ef91120ffe80040c699e747a1ad68
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#ad54da9241deabb3601e6e0e8fa832c19
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#abfc9b0aa975206f7e77a125e6b78536e
...
// https://ffmpeg.org/doxygen/7.1/structAVCodecParameters.html#a51639f88aef9f4f283f538a0c033fbb8
...
// https://ffmpeg.org/doxygen/7.1/group__lavc__core.html#ga506c1c185ac48bb0086c61e267fc085c
...
// https://ffmpeg.org/doxygen/7.1/group__lavc__core.html#ga8a4998c9d1695abb01d379539d313227
func (cp *CodecParameters) ToCodecContext(cc *CodecContext) error {
	return newError(C.avcodec_parameters_to_context(cc.c, cp.c))
}

// https://ffmpeg.org/doxygen/7.1/group__lavc__core.html#ga6d02e640ccc12c783841ce51d09b9fa7
