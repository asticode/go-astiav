...
// https://ffmpeg.org/doxygen/8.0/group__lavc__misc.html#ga11f785a188d7d9df71621001465b0f1d
func (f *Frame) FillAudioFrame(nbChannels int, sampleFmt SampleFormat, buf []byte, align int) error {
...
// https://ffmpeg.org/doxygen/8.0/group__lavu__frame.html#ga11f785a188d7d9df71621001465b0f1d
func (f *Frame) SetFormat(format int) {
	f.c.format = C.int(format)
}
