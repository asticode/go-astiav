...
// https://ffmpeg.org/doxygen/8.1/frame_8h.html#add80189702cf0f5ea82718576fb43201
const NumDataPointers = uint(C.AV_NUM_DATA_POINTERS)

// https://ffmpeg.org/doxygen/8.1/structAVFrame.html
type Frame struct {
	c *C.AVFrame
}
...
// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#gac700017c5270c79c1e1befdeeb008b2f
func AllocFrame() *Frame {
	return newFrameFromC(C.av_frame_alloc())
}

// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#ga6b1acbfa82c79bf7fd78d868572f0ceb
func (f *Frame) AllocBuffer(align int) error {
	return newError(C.av_frame_get_buffer(f.c, C.int(align)))
}

// https://ffmpeg.org/doxygen/8.1/hwcontext_8c.html#adfa5aaa3a4f69b163ea30cadc6d663dc
func (f *Frame) AllocHardwareBuffer(hfc *HardwareFramesContext) error {
	return newError(C.av_hwframe_get_buffer(hfc.c, f.c, 0))
}

// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#ae291cdec7758599e765bc9e3edbb3065
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a853afbad220bbc58549b4860732a3aa5
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a9262c231f1f64869439b4fe587fe1710
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a1d0f65014a8d1bf78cec8cbed2304992
...
func (f *Frame) DataPtr(index int) unsafe.Pointer {
	if index < 0 || index >= int(NumDataPointers) {
		return nil
	}
	return unsafe.Pointer(f.c.data[index])
}
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a29493fbfabaa21432c360a090426aa8e
func (f *Frame) HardwareFramesContext() *HardwareFramesContext {
	return newHardwareFramesContextFromC(f.c.hw_frames_ctx)
}

// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a3f89733f429c98ba5bc64373fb0a3f13
...
// https://ffmpeg.org/doxygen/8.1/group__lavu__picture.html#ga24a67963c3ae0054a2a4bab35930e694
...
// https://ffmpeg.org/doxygen/8.1/group__lavu__picture.html#ga6f8576f1ef0c2d9a9f7c5ac7f9a28c52
...
// https://ffmpeg.org/doxygen/8.1/group__lavu__picture.html#ga3fa8e484cc214e8c7b9026825b5f4078
...
// https://ffmpeg.org/doxygen/8.1/group__lavu__sampfmts.html#gaa7368bc4e3a366b688e81938ed55eb06
...
// https://ffmpeg.org/doxygen/8.1/group__lavu__sampmanip.html#gabcb166e22938c7d93c2d609529c458bb
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#aa52bfc6605f6a3059a0c3226cc0f6567
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a02f45ab8191aea1660159f1e464237ea
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#af9920fc3fbfa347b8943ae461b50d18b
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#aed14fa772ce46881020fd1545c86432c
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#aa52951f35ec9e303d3dfeb4b3e44248a
func (f *Frame) PktDts() int64 {
	return int64(f.c.pkt_dts)
}

// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a0452833e3ab6ddd7acbf82817a7818a4
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a62f9c20541a83d37db7072126ff0060d
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#ac85daa1316e1f47e78da0ca19b7c60e6
...
// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a44d40e03fe22a0511c9157dab22143ee
func (f *Frame) SideData() *FrameSideData {
	return newFrameSideDataFromC(&f.c.side_data, &f.c.nb_side_data)
}

// https://ffmpeg.org/doxygen/8.1/structAVFrame.html#a1e71ce60cedd5f3b6811714a9f7f9e0a
...
// https://ffmpeg.org/doxygen/8.1/hwcontext_8c.html#abf1b1664b8239d953ae2cac8b643815a
func (f *Frame) TransferHardwareData(dst *Frame) error {
	return newError(C.av_hwframe_transfer_data(dst.c, f.c, 0))
}

// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#ga979d73f3228814aee56aeca0636e37cc
func (f *Frame) Free() {
	if f.c != nil {
		C.av_frame_free(&f.c)
	}
...
// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#ga88b0ecbc4eb3453eef3fbefa3bddeb7c
func (f *Frame) Ref(src *Frame) error {
	return newError(C.av_frame_ref(f.c, src.c))
}

// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#ga46d6d32f6482a3e9c19203db5877105b
func (f *Frame) Clone() *Frame {
	return newFrameFromC(C.av_frame_clone(f.c))
}

// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#ga0a2b687f9c1c5ed0089b01fd61227108
func (f *Frame) Unref() {
	C.av_frame_unref(f.c)
}

// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#ga709e62bc2917ffd84c5c0f4e1dfc48f7
...
// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#ga3ba755bada5c3c8883361ef43fb5fb7a
func (f *Frame) IsWritable() bool {
	return C.av_frame_is_writable(f.c) > 0
}

// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#gadd5417c06f5a6b419b0dbd8f0ff363fd
func (f *Frame) MakeWritable() error {
	return newError(C.av_frame_make_writable(f.c))
}

// https://ffmpeg.org/doxygen/8.1/group__lavu__frame.html#gaec4e92f6e1e75ffaf76e07586fb0c9ed
