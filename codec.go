...
// https://ffmpeg.org/doxygen/8.1/structAVCodec.html
type Codec struct {
	c *C.AVCodec
}
...
// https://ffmpeg.org/doxygen/8.1/structAVCodec.html#ad3daa3e729850b573c139a83be8938ca
...
// https://ffmpeg.org/doxygen/8.1/structAVCodec.html#a01a53d07936f4c7ee280444793b6967b
func (c *Codec) ID() CodecID {
	return CodecID(c.c.id)
}

// https://ffmpeg.org/doxygen/8.1/structAVCodec.html#a710e3bd3081124ef3364b0c520379dd8
...
// https://ffmpeg.org/doxygen/8.1/group__lavc__core.html#ga6dc18eef1afca3610644a52565cf8a31
func (c *Codec) IsDecoder() bool {
	return int(C.av_codec_is_decoder(c.c)) != 0
}

// https://ffmpeg.org/doxygen/8.1/group__lavc__core.html#ga2b665824e4d9144f8d4f6c01e3e85aa3
func (c *Codec) IsEncoder() bool {
	return int(C.av_codec_is_encoder(c.c)) != 0
}

// https://ffmpeg.org/doxygen/8.1/structAVCodec.html#ac2b97bd3c19686025e1b7d577329c250
...
// https://ffmpeg.org/doxygen/8.1/structAVCodec.html#aac19f4c45370f715412ad5c7b78daacf
...
// https://ffmpeg.org/doxygen/8.1/group__lavc__core.html#ga51e35d01da2b3833b3afa839212c58fa
func FindDecoder(id CodecID) *Codec {
	return newCodecFromC(C.avcodec_find_decoder((C.enum_AVCodecID)(id)))
}

// https://ffmpeg.org/doxygen/8.1/group__lavc__core.html#gad4e08a758f3560006145db074d16cb47
...
// https://ffmpeg.org/doxygen/8.1/group__lavc__core.html#ga68e4b5f31de5e5fc25d5781a1be22331
func FindEncoder(id CodecID) *Codec {
	return newCodecFromC(C.avcodec_find_encoder((C.enum_AVCodecID)(id)))
}

// https://ffmpeg.org/doxygen/8.1/group__lavc__core.html#ga9fa02c1eae54a2ec67beb789c2688d6e
...
// https://ffmpeg.org/doxygen/8.1/group__lavc__core.html#ga4f80582a2ea9c0e141de5d6f6152008f
...
// https://ffmpeg.org/doxygen/8.1/group__lavc__core.html#ga7cd040fcc147340186deb0c54dc996b0
