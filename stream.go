...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html
type Stream struct {
	c *C.AVStream
}
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a946e1e9b89eeeae4cab8a833b482c1ad
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a4737d8b012827558f55a6f559b253496
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a12826d21779289356722971d362c583c
func (s *Stream) CodecParameters() *CodecParameters {
	return newCodecParametersFromC(s.c.codecpar)
}

// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a492fcecc45dbbd8da51edd0124e9dd30
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#aea05abdb8e45405048d7923a68c23ef5
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a4e04af7a5a4d8298649850df798dd0bc
func (s *Stream) Duration() int64 {
	return int64(s.c.duration)
}

// https://ffmpeg.org/doxygen/7.1/structAVStream.html#ab76e176c2a1d1ff09ec9c0bb88dc25e9
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a6873ed62f196c24e8bf282609231786f
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a6ca823054632821e085377f7d371a2d1
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a50d250a128a3da9ce3d135e84213fb82
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a4382c3064df1c9eb232ac198dec067f9
func (s *Stream) NbFrames() int64 {
	return int64(s.c.nb_frames)
}

// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a6cdb0c90a69899f4e1e54704bb654936
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#ad63fb11cc1415e278e09ddc676e8a1ad
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a3f19c60ac6da237cd10e4d97150c118e
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a7c67ae70632c91df8b0f721658ec5377
...
// https://ffmpeg.org/doxygen/7.1/structAVStream.html#a9db755451f14e2bf590d4b85d82b32e6
